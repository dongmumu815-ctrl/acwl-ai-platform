...
async def main():
    async with AsyncSessionLocal() as session:
        # 1. Get Template (we just need the compose file mostly)
        ...
        # We need to create a harbor.yml file for the prepare tool
        harbor_yml = """
...
"""
        ...
        try:
            ...
            # We use goharbor/prepare:v2.10.0 (matching the version in yml)
            ...
            # Upload Compose (Overwrite the one generated by prepare if any, or use ours)
            # Actually, prepare generates docker-compose.yml too usually? No, prepare just generates config.
            # We need to provide the compose file.
            ...
            print("Official Reinstall Complete.")
