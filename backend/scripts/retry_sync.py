...
async def main():
    ...
    for tag in tags:
        ...
        # We try both endpoints just in case
        endpoints = [
            "http://127.0.0.1:8080/service/notifications",
            "http://127.0.0.1:8080/service/registry/notifications",
            "http://127.0.0.1:8080/api/v2.0/notifications"
        ]
