...
): Promise<StatisticsResponse<StatisticsData>> => {
  return request({
...
export const getAccessTrend = (
  params: AccessTrendQuery,
): Promise<StatisticsResponse<AccessTrendData>> => {
  return request({
 ...
 * 获取资源类型分布
 */
export const getResourceTypeDistribution = (): Promise<
  StatisticsResponse<ResourceTypeDistribution[]>
> => {
  return request({
...
export const getPopularResources = (
  params: PopularResourceQuery,
): Promise<StatisticsResponse<PopularResource[]>> => {
  return request({
...
): Promise<StatisticsResponse<UserActivityData>> => {
  return request({
 ...
 * 获取访问记录列表
 */
export const getAccessRecords = (
  params: AccessRecordQuery,
): Promise<PaginatedStatisticsResponse<AccessRecord>> => {
  return request({
 ...
 * 获取访问记录详情
 */
export const getAccessRecordById = (
  id: string,
): Promise<StatisticsResponse<AccessRecord>> => {
  return request({
 ...
 * 获取实时统计数据
 */
export const getRealTimeStats = (): Promise<
  StatisticsResponse<RealTimeStats>
> => {
  return request({
...
export const getPerformanceMetrics = (
  params?: StatisticsQuery,
): Promise<StatisticsResponse<PerformanceMetrics>> => {
  return request({
 ...
 * 获取资源使用统计
 */
export const getResourceUsageStats = (
  params?: StatisticsQuery,
): Promise<StatisticsResponse<ResourceUsageStats[]>> => {
  return request({
...
export const getUserBehaviorStats = (
  params?: StatisticsQuery,
): Promise<StatisticsResponse<UserBehaviorStats[]>> => {
  return request({
...
export const getSystemHealth = (): Promise<
  StatisticsResponse<SystemHealth>
> => {
  return request({
...
export const getDataQualityStats = (
  params?: StatisticsQuery,
): Promise<StatisticsResponse<DataQualityStats[]>> => {
  return request({
...
export const getCostAnalysis = (
  params?: StatisticsQuery,
): Promise<StatisticsResponse<CostAnalysis>> => {
  return request({
 ...
 * 获取容量规划
 */
export const getCapacityPlanning = (): Promise<
  StatisticsResponse<CapacityPlanning>
> => {
  return request({
 ...
 * 获取合规性统计
 */
export const getComplianceStats = (): Promise<
  StatisticsResponse<ComplianceStats>
> => {
  return request({
...
): Promise<StatisticsResponse<AlertRule>> => {
  return request({
    url: "/api/statistics/alert-rules",
    method: "post",
    data,
...
export const deleteAlertRule = (
  id: string,
): Promise<StatisticsResponse<void>> => {
  return request({
    url: `/api/statistics/alert-rules/${id}`,
    method: "delete",
 ...
 * 获取告警记录详情
 */
export const getAlertRecordById = (
  id: string,
): Promise<StatisticsResponse<AlertRecord>> => {
  return request({
...
export const validateQuery = (
  query: string,
): Promise<StatisticsResponse<{ valid: boolean; error?: string }>> => {
  return request({
