...
export const createCustomer = (
  ...
  if (typeof data.rate_limit !== "undefined")
    formData.append("rate_limit", String(data.rate_limit));
  if (typeof data.max_apis !== "undefined")
    formData.append("max_apis", String(data.max_apis));
 ...
 * 重置平台密钥
 */
export const resetCustomerSecret = (
  id: number,
): Promise<ApiResponse<{ app_secret: string }>> => {
  return request({
...
export const getApis = (
  params?: PaginationParams,
): Promise<ApiResponse<PaginatedResponse<CustomApi>>> => {
  return request({
    url: "/apis",
    method: "get",
    params,
 ...
 * 保存API字段映射
 */
export const saveApiFieldMapping = (
  apiId: number,
  data: {
...
export const updateFieldsOrder = (
  apiId: number,
  fields: Array<{ id: number; field_order: number }>,
): Promise<ApiResponse<void>> => {
  return request({
...
export const getBatches = (
  params?: PaginationParams,
): Promise<ApiResponse<PaginatedResponse<DataBatch>>> => {
  return request({
    url: "/batches",
    method: "get",
    params,
 ...
 */
export const getTypeCountTrend = (params?: {
  days?: number;
  start_date?: string;
  end_date?: string;
}): Promise<
  ApiResponse<{ dates: string[]; series: Record<string, number[]> }>
> => {
  return request({
 ...
 * 获取批次状态统计
 */
export const getBatchStatusStats = (): Promise<
  ApiResponse<BatchStatusStats>
> => {
  return request({
 ...
 * 获取资源类型列表
 */
export const getResourceTypes = (): Promise<
  ApiResponse<{
