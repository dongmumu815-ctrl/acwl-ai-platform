 ...
 * 获取数据资源列表
 */
export const getResources = (params: ResourceQuery): Promise<PaginatedResourceResponse<DataResource>> => {
  return request({
    url: '/api/resources',
    method: 'get',
    params
 ...
 * 创建数据资源
 */
export const createResource = (data: ResourceCreateData): Promise<ResourceResponse<DataResource>> => {
  return request({
    url: '/api/resources',
    method: 'post',
    data
 ...
 * 更新数据资源
 */
export const updateResource = (id: string, data: ResourceUpdateData): Promise<ResourceResponse<DataResource>> => {
  return request({
    url: `/api/resources/${id}`,
    method: 'put',
    data
 ...
 * 批量删除数据资源
 */
export const batchDeleteResources = (ids: string[]): Promise<ResourceResponse<void>> => {
  return request({
 ...
 * 复制数据资源
 */
export const copyResource = (id: string, data: { name: string; description?: string }): Promise<ResourceResponse<DataResource>> => {
  return request({
 ...
 * 启用/禁用数据资源
 */
export const toggleResource = (id: string, enabled: boolean): Promise<ResourceResponse<void>> => {
  return request({
 ...
 * 测试数据资源连接
 */
export const testConnection = (data: ResourceTestConnection): Promise<ResourceResponse<{ success: boolean; message: string; details?: any }>> => {
  return request({
 ...
 * 同步数据资源结构
 */
export const syncResourceStructure = (id: string, data?: ResourceSyncData): Promise<ResourceResponse<{ success: boolean; message: string; changes?: any }>> => {
  return request({
 ...
 * 获取同步历史
 */
export const getSyncHistory = (id: string, params?: { page?: number; size?: number }): Promise<PaginatedResourceResponse<any>> => {
  return request({
 ...
 * 预览数据资源数据
 */
export const previewResourceData = (id: string, params?: {
  table?: string
  limit?: number
  offset?: number
 ...
 * 查询数据资源数据
 */
export const queryResourceData = (id: string, data: {
  sql?: string
  table?: string
  fields?: string[]
  filters?: Record<string, any>
 ...
 * 获取资源字段结构
 */
export const getResourceFields = (id: string, table?: string): Promise<ResourceResponse<ResourceField[]>> => {
  return request({
 ...
 * 更新字段描述
 */
export const updateFieldDescription = (id: string, fieldId: string, description: string): Promise<ResourceResponse<void>> => {
  return request({
 ...
 * 批量更新字段描述
 */
export const batchUpdateFieldDescriptions = (id: string, fields: { fieldId: string; description: string }[]): Promise<ResourceResponse<void>> => {
  return request({
 ...
 * 获取资源访问记录
 */
export const getResourceAccessRecords = (id: string, params?: {
  page?: number
  size?: number
  startDate?: string
  endDate?: string
 ...
 * 记录资源访问
 */
export const recordResourceAccess = (id: string, data: {
  operation: string
  details?: any
  ip?: string
  userAgent?: string
 ...
 * 添加资源权限
 */
export const addResourcePermission = (id: string, data: {
  userId?: string
  roleId?: string
  permissions: string[]
 ...
 * 更新资源权限
 */
export const updateResourcePermission = (id: string, permissionId: string, data: {
  permissions: string[]
}): Promise<ResourceResponse<ResourcePermission>> => {
  return request({
 ...
 * 检查用户对资源的权限
 */
export const checkResourcePermission = (id: string, permission: string): Promise<ResourceResponse<{ hasPermission: boolean }>> => {
  return request({
 ...
 * 添加资源标签
 */
export const addResourceTags = (id: string, tags: string[]): Promise<ResourceResponse<void>> => {
  return request({
    url: `/api/resources/${id}/tags`,
    method: 'post',
    data: { tags }
 ...
 * 删除资源标签
 */
export const removeResourceTags = (id: string, tags: string[]): Promise<ResourceResponse<void>> => {
  return request({
    url: `/api/resources/${id}/tags`,
    method: 'delete',
    data: { tags }
 ...
 * 创建资源版本
 */
export const createResourceVersion = (id: string, data: {
  version: string
  description?: string
  changes?: string
 ...
 * 比较版本差异
 */
export const compareResourceVersions = (id: string, fromVersion: string, toVersion: string): Promise<ResourceResponse<any>> => {
  return request({
 ...
 * 创建资源备份
 */
export const createResourceBackup = (id: string, data: {
  name: string
  description?: string
  includeData?: boolean
 ...
 * 获取资源监控指标
 */
export const getResourceMetrics = (id: string, params?: {
  startDate?: string
  endDate?: string
  metrics?: string[]
 ...
 * 验证资源数据质量
 */
export const validateResourceData = (id: string, data?: {
  rules?: string[]
  sample?: boolean
  sampleSize?: number
 ...
 * 获取资源模板列表
 */
export const getResourceTemplates = (type?: string): Promise<ResourceResponse<ResourceTemplate[]>> => {
  return request({
 ...
 * 从模板创建资源
 */
export const createResourceFromTemplate = (templateId: string, data: {
  name: string
  description?: string
  categoryId?: string
 ...
 * 将资源保存为模板
 */
export const saveResourceAsTemplate = (id: string, data: {
  name: string
  description?: string
  isPublic?: boolean
 ...
 * 导入资源配置
 */
export const importResourceConfig = (file: File): Promise<ResourceResponse<DataResource>> => {
 ...
 * 批量导入资源
 */
export const batchImportResources = (data: ResourceImportData[]): Promise<ResourceResponse<{ success: number; failed: number; errors: any[] }>> => {
  return request({
 ...
 * 批量更新资源
 */
export const batchUpdateResources = (operations: ResourceBatchOperation[]): Promise<ResourceResponse<{ success: number; failed: number; errors: any[] }>> => {
  return request({
 ...
 * 批量移动资源到分类
 */
export const batchMoveResources = (ids: string[], categoryId: string): Promise<ResourceResponse<void>> => {
  return request({
 ...
 * 批量添加标签
 */
export const batchAddTags = (ids: string[], tags: string[]): Promise<ResourceResponse<void>> => {
  return request({
 ...
 * 批量删除标签
 */
export const batchRemoveTags = (ids: string[], tags: string[]): Promise<ResourceResponse<void>> => {
  return request({
 ...
 * 获取搜索建议
 */
export const getSearchSuggestions = (keyword: string): Promise<ResourceResponse<string[]>> => {
  return request({
 ...
 * 获取资源分类树
 */
export const getResourceCategories = (): Promise<ResourceResponse<ResourceCategory[]>> => {
  return request({
 ...
 * 获取分类详情
 */
export const getCategoryById = (id: string): Promise<ResourceResponse<ResourceCategory>> => {
  return request({
 ...
 * 删除资源分类
 */
export const deleteCategory = (id: string, moveToId?: string): Promise<ResourceResponse<void>> => {
  return request({
    url: `/api/resource-categories/${id}`,
    method: 'delete',
    params: { moveToId }
 ...
 * 移动分类
 */
export const moveCategory = (id: string, parentId: string, sortOrder?: number): Promise<ResourceResponse<void>> => {
  return request({
 ...
 * 获取分类下的资源数量
 */
export const getCategoryResourceCount = (id: string): Promise<ResourceResponse<{ count: number }>> => {
  return request({
