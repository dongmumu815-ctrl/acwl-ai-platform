...
export const listResourceTypes = (
  ...
  return get<ResourceTypeListResponse>(
    `${BASE}/list`,
    { page, page_size, name },
...
export const getResourceType = (
  id: string,
): Promise<ApiResponse<ResourceTypeItem>> => {
  return get<ResourceTypeItem>(`${BASE}/${id}`, undefined, {
    permission: "data:resource_type:view",
  });
};
...
export const createResourceType = (
  ...
  return post<ResourceTypeItem>(`${BASE}/create`, data, {
    permission: "data:resource_type:create",
  });
};
