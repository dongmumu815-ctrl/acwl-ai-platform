...
class DataInsightAPI {
  ...
  datasource = {
    ...
    testConnection: (
      ...
      this.api.post(
        DATA_INSIGHT_CONFIG.endpoints.datasource.testConnection,
        data,
      ),
  ...
  explorer = {
    ...
    getSchemas: (datasourceId: number): Promise<SchemaInfo[]> =>
      this.api.get(
        DATA_INSIGHT_CONFIG.endpoints.explorer.getSchemas(datasourceId),
      ),

    // 获取表列表
    getTables: (datasourceId: number): Promise<TableInfo[]> =>
      this.api.get(
        DATA_INSIGHT_CONFIG.endpoints.explorer.getTables(datasourceId),
      ),
    ...
    getTablesBySchema: (
      ...
      this.api.get(
        DATA_INSIGHT_CONFIG.endpoints.explorer.getTablesBySchema(
          datasourceId,
          schema,
        ),
      ),
    ...
    getTableDetail: (
      ...
      const url = DATA_INSIGHT_CONFIG.endpoints.explorer.getTableDetail(
        datasourceId,
        tableName,
      );
    ...
    getTableData: (params: TableDataRequest): Promise<SQLExecuteResponse> =>
      this.api.post(
        DATA_INSIGHT_CONFIG.endpoints.explorer.getTableData,
        params,
      ),
