      ...
      <div class="header-left">
        ...
        <div class="title-section">
          ...
          <p class="page-description">
            {{ isEdit ? "修改数据资源信息" : "添加新的数据资源到系统中" }}
          </p>
        </div>
      </div>
      <div class="header-actions">
        <el-button :disabled="saving" @click="saveDraft">
        ...
        <el-card class="form-section">
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              ...
              <el-form-item v-else-if="formData.type === 'api'" label="API路径">
                <el-input
          ...
          <el-form-item>
            ...
            <span v-if="connectionStatus" class="connection-status">
              <el-icon v-if="connectionStatus === 'success'" class="success"
                ><SuccessFilled
              /></el-icon>
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="12">
              <el-form-item label="数据敏感度">
                <el-select
                  v-model="formData.access.sensitivity"
                  placeholder="请选择敏感度"
                  style="width: 100%"
                >
                  <el-option label="公开" value="public" />
