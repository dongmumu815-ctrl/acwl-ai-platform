<template>
  <div class="auth-error-test">
    ...
    <div class="test-buttons">
      <el-button @click="testValidToken" type="primary">测试有效Token</el-button>
      <el-button @click="testInvalidToken" type="danger">测试无效Token</el-button>
      <el-button @click="testAuthenticationError" type="warning">测试AUTHENTICATION_ERROR</el-button>
    </div>
