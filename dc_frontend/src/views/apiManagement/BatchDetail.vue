<template>
  <div class="batch-detail">
      ...
      <div class="header-content">
        <div class="header-left">
          ...
          <div class="title-section">
            ...
            <p class="page-description" v-if="batchInfo">
        ...
        <div class="header-right">
          ...
          <el-button 
            v-if="batchInfo?.status === 'completed' && batchInfo?.result_file_path" 
            type="info" 
    ...
    <!-- 批次基本信息 -->
    <div class="page-card" v-if="batchInfo">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="6">
            <div class="progress-item">
              ...
              <div class="progress-value success">{{ batchInfo.processed_records }}</div>
            </div>
          </el-col>
          <el-col :span="6">
            <div class="progress-item">
              <div class="progress-label">失败数</div>
              <div class="progress-value danger">{{ batchInfo.failed_records }}</div>
            </div>
          </el-col>
          <el-col :span="6">
            <div class="progress-item">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="6">
            <div class="info-item">
              ...
              <span class="value">{{ batchInfo.started_at ? formatDate(batchInfo.started_at) : '未开始' }}</span>
            </div>
          </el-col>
          <el-col :span="6">
            <div class="info-item">
              <span class="label">完成时间:</span>
              <span class="value">{{ batchInfo.completed_at ? formatDate(batchInfo.completed_at) : '未完成' }}</span>
            </div>
          </el-col>
          <el-col :span="6">
            <div class="info-item">
    ...
    <!-- 错误信息 -->
    <div class="page-card" v-if="batchInfo?.error_message">
      <div class="card-header">
        <h3>错误信息</h3>
      </div>
...
const getProgress = () => {
  ...
  return Math.round((batchInfo.value.processed_records / batchInfo.value.total_records) * 100)
}
...
const getSuccessRate = () => {
  ...
  const successCount = batchInfo.value.processed_records - batchInfo.value.failed_records
