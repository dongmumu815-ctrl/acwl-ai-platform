  ...
  <div class="batch-management">
    ...
    <div class="page-card">
      ...
      >
        ...
        <el-table-column prop="batch_name" label="批次名称" width="150" sortable />
        ...
        <el-table-column prop="total_records" label="总记录数" width="100" sortable />
        <el-table-column prop="processed_records" label="已处理" width="100" sortable />
        <el-table-column prop="failed_records" label="失败数" width="100" sortable />
...
import type { DataBatch, DataBatchCreate, Customer } from '@/types/apiManagement'
...
const filteredBatches = computed(() => {
  ...
  if (customerFilter.value) {
    result = result.filter(batch => batch.customer_id === customerFilter.value)
  }
...
const updateStats = () => {
  ...
  stats.processing = batches.value.filter(b => b.status === 'processing').length
  stats.completed = batches.value.filter(b => b.status === 'completed').length
