<template>
  <div class="api-management">
          ...
          <div class="stat-card">
            ...
            <div class="stat-content">
              <div class="stat-value">
                {{ formatNumber(apiStats.totalCalls) }}
              </div>
          ...
          <div class="card-header">
            ...
            <div class="header-actions">
              <span class="total-count"
                >共 {{ filteredApis.length }} 条记录</span
              >
              <el-radio-group
                v-model="viewMode"
                size="small"
            ...
            <template #default="{ row }">
              <div class="api-stats">
                <div class="stats-number">
                  {{ formatNumber(row.total_calls || 0) }}
                </div>
              ...
              <div class="api-card">
                <div class="api-card-header">
                  <div class="api-method">
                    <el-tag
                      :type="getMethodTagType(api.http_method)"
                      size="small"
                      effect="light"
                    >
                      {{ api.http_method }}
                  ...
                  <div class="api-status">
                    <el-tag
                      :type="api.is_active ? 'success' : 'danger'"
                      size="small"
                      effect="light"
                    >
                      {{ api.is_active ? "激活" : "禁用" }}
                  ...
                  <div class="api-meta">
                    ...
                    <div class="meta-item">
                      ...
                      <el-tag size="small" type="success">{{
                        api.response_format.toUpperCase()
                      }}</el-tag>
                    </div>
                  </div>
    ...
    <!-- 复制API对话框 -->
    <el-dialog v-model="copyDialogVisible" title="复制API" width="600px">
